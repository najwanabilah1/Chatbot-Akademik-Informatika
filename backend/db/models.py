...
def now_wib():
    return datetime.utcnow().replace(tzinfo=pytz.utc).astimezone(WIB).replace(tzinfo=None)
...
class LoginHistory(db.Model):
    ...
    login_time = db.Column(db.DateTime, default=now_wib)
...
class ChatMessage(db.Model):
    ...
    timestamp = db.Column(db.DateTime, default=now_wib)
...
class TopicStats(db.Model):
    ...
    last_updated = db.Column(db.DateTime, default=now_wib)
...
class Dataset(db.Model):
    ...
    updated_at = db.Column(db.DateTime, default=now_wib)
...
class Peraturan(db.Model):
    ...
    uploaded_at = db.Column(db.DateTime, default=now_wib)
